...
class MD_Custom_Modules_Example_Loader {
	...
	static public function register_fields( $fields ) {
		$fields['my-custom-field'] = MOPDOGBB_DIR . 'fields/my-custom-field.php';
		return $fields;
	}
	...
	static public function enqueue_field_assets() {
		...
		wp_enqueue_style( 'my-custom-fields', MOPDOGBB_URL . 'assets/css/fields.css', array(), '' );
		wp_enqueue_script( 'my-custom-fields', MOPDOGBB_URL . 'assets/js/fields.js', array(), '', true );
	}
}
